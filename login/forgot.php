...
if (isset($_POST['submit'])) {
  ...
  $stmt = $conn->prepare("SELECT * FROM user WHERE email=?");
    ...
    $mail_body = 'Click the link below to reset your password: <br>' .
      '<a href="http://localhost/master/EstudyanTipid/login/Reset.php?token=' . $token . '">Reset Password</a>';
...
<head>
  <title>EstyudanTipid | Forgot Password</title>
...
<body style=" background:#51D289;">
  <div class="box col-md-5 align-items-center position-absolute top-50 start-50 translate-middle">
    <div class="p-4 text-center mt-5 text-dark fw-bold">
      <img src="a.png" class="mb-3">
    ...
    <div class="d-grid gap-2 mb-3 ms-5 me-5 mt-3">
      <button class="btn btn-success text-light fs-5" type="submit" name="submit">Next</button>
    </div>
