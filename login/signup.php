  ...
  <div class="box col-md-4 align-items-center position-absolute top-50 start-50 translate-middle">
    <form method="post" action="">
      ...
      <div class="form-floating mb-3 ms-5 me-5">
        <input type="text" class="form-control" id="floatingFName" placeholder="name@example.com" name="first_name" required>
        <label for="floatingInput">First Name</label>
      </div>


      <div class="form-floating mb-3 ms-5 me-5">
        <input type="text" class="form-control" id="floatingLName" placeholder="name@example.com" name="last_name" required>
      ...
      <div class="d-grid gap-2 mb-3 ms-5 me-5 mt-3">
        <a href="login\budget.php"><button class="btn btn-success text-light fs-5" type="submit" name="signup">Sign Up</button></a>
      </div>
